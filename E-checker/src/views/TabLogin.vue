<template>
  <ion-page>
    <ion-header>
      <ion-toolbar>
        <ion-title>Prijavite se v e-storitev E-dentiteta</ion-title>
      </ion-toolbar>
    </ion-header>
    <ion-content :fullscreen="true">
      <ion-header collapse="condense">
        <ion-toolbar>
          <ion-title size="large">Prijavite se v e-storitev E-dentiteta</ion-title>
        </ion-toolbar>
      </ion-header>
      <ion-card>
        <ion-card-content
...
export default {
  ...
  created() {
    ...
    const value: string | null = searchParams.get("id");
    console.log(value);
    ...
    if(myParam != "abcabcabcabcabcabcabcabc123123123123"){
      ...
      axios
      .post("https://e-checker.usdd.company/APIs/id.php", formData)
      .then((response) => {
